...
class UIManager:
    ...
    def get_input(self, echo: bool = False) -> int:
        ...
        try:
            c = self.stdscr.getch()
            # Explicitly convert any return value to int
    ...
    def get_string(self, y: int, x: int, prompt: str = "") -> str:
        ...
        Args:
            y: Y coordinate to display prompt
            x: X coordinate to display prompt
            prompt: Prompt text
    ...
    def with_ui_context(self, callback: Callable[[], Any]) -> Any:
        ...
        Args:
            callback: Function to run within UI context
